...
if (isLocalhost()) {
  ...
  // load CDN config emitted to /assets/scripts/cdn-config.js (generated by scripts/generate_cdn_config.js)
  try { importScripts('/assets/scripts/cdn-config.js'); } catch(e) { /* ignore if not available */ }
...
async function handleFetch(request) {
  ...
  // Bypass SW for external CDN PDFs
  if (url.href.startsWith(((self.MATERIO_CONFIG && self.MATERIO_CONFIG.cdnBaseUrl) || 'https://cdn-materioa.netlify.app') + '/pdfs/')) {
    // Always fetch directly, do not cache or fallback
